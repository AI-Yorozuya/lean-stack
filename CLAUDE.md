...
**使用者若是學員／玩家——打招呼、問「這是什麼」「怎麼開始（學習）」、或任何非開發性質的開場——第一個動作：`Read .claude/skills/coach/SKILL.md`，然後完全照它演出（開店記教練）。**不要自己導覽 repo、不要列學習路線簡報、不要照 START.md 跑 runbook——那些都由教練劇本統籌。
